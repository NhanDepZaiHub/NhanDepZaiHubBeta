...
-- Kiểm tra xem v15 có được tạo không
if not v15 then
...
local Tabs = {
    Home = v15:CreateTab("Thông Tin") or warn("Lỗi tạo tab Home"),
    Main = v15:CreateTab("Cày") or warn("Lỗi tạo tab Main"),
    Sea = v15:CreateTab("Sự Kiện") or warn("Lỗi tạo tab Sea"),
    Draco = v15:CreateTab("Draco") or warn("Lỗi tạo tab Draco"),
    ITM = v15:CreateTab("Vật Phẩm") or warn("Lỗi tạo tab ITM"),
    Levi = v15:CreateTab("Cày Levi") or warn("Lỗi tạo tab Levi"),
    Setting = v15:CreateTab("Cài Đặt") or warn("Lỗi tạo tab Setting"),
    Status = v15:CreateTab("Máy Chủ") or warn("Lỗi tạo tab Status"),
    Stats = v15:CreateTab("Chỉ Số") or warn("Lỗi tạo tab Stats"),
    Player = v15:CreateTab("Người Chơi") or warn("Lỗi tạo tab Player"),
    Teleport = v15:CreateTab("Dịch Chuyển") or warn("Lỗi tạo tab Teleport"),
    Visual = v15:CreateTab("Troll") or warn("Lỗi tạo tab Visual"),
    Fruit = v15:CreateTab("Trái") or warn("Lỗi tạo tab Fruit"),
    Raid = v15:CreateTab("Tập Kích") or warn("Lỗi tạo tab Raid"),
    Race = v15:CreateTab("Tộc") or warn("Lỗi tạo tab Race"),
    Shop = v15:CreateTab("Cửa Hàng") or warn("Lỗi tạo tab Shop"),
    Misc = v15:CreateTab("Khác") or warn("Lỗi tạo tab Misc")
}
