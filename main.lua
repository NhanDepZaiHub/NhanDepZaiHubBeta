...
if getgenv().Nhân DzRan then
	warn("ALREADY OPEN")
	return
end
getgenv().Nhân DzRan=true
...
local L_34_ = L_33_:Window("Nhân Dz Hub 25ms was here", Enum.KeyCode.LeftControl)
print("|Nhân Dz DEBUG| Anti AFK")
game:GetService("Players").LocalPlayer.Idled:connect(function()
	print("|Nhân Dz DEBUG| AFK detected, prevented +1")
...
spawn(function()
	print("|Nhân Dz DEBUG| Anti Stranger Join")
	while wait() do
		pcall(function()
			if _25msShared.AntiStranger then
				for L_222_forvar0, L_223_forvar1 in pairs(game:GetService("Players"):GetChildren()) do
					if L_223_forvar1.Data.Level.Value >= 2601 or L_223_forvar1.Data.Level.Value > 20000 then
						game.Players.LocalPlayer:Kick("Nhân Dz Hub found an Admin!")
						print("|Nhân Dz DEBUG| Detected Stranger, Hopping Server...")
						Hop()
					end
				end
			end
	...
	task.spawn(function()
		...
		if setfflag then
			task.spawn(function()
				...
				print("|Nhân Dz DEBUG| Anti Ban Loaded in: " .. os.clock() - L_228_)
			end)
		else
			print("|Nhân Dz DEBUG| Anti Ban not support this Executor!")
		end
	end)
end)
L_35_.Setting:Line()
...
function CheckMirage()
	if L_13_.Locations:FindFirstChild("Mirage Island") then
		return "Mirage Island: 🟢 Có"
	else
		return "Mirage Island: 🔴 đéo Có"
	end
end;
function CheckKitsune()
	if L_13_:FindFirstChild("Kitsune Island") then
		return "Kitsune Island: 🟢 có"
	else
		return "Kitsune Island: 🔴 đéo Có"
	end
end;
...
task.delay(2, function()
	if hookfunction and not islclosure(hookfunction) then
		print("|Nhân Dz DEBUG| Remove Effects")
...
print("|Nhân Dz DEBUG| Done loaded Nhân Dz in: " .. os.clock() - L_1_)
