...
_G.FastAttack = true    
    ...
    local ToggleLevel = Tabs.Main:AddToggle("ToggleLevel", {Title = "Cày level đi cu", Default = false })
    ...
    local ToggleCastleRaid = Tabs.Main:AddToggle("ToggleCastleRaid", {Title = "Auto tập kích", Default = false })
...
if Third_Sea then
local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Auto cày xương", Default = false })
...
spawn(function()
    ...
    local ToggleSpawnCake = Tabs.Main:AddToggle("ToggleSpawnCake", {Title = "Auto triệu hồi lính bánh kẹo", Default = true })
...
local boss = Tabs.Main:AddSection("Boss Farm")
	...
	local ToggleAutoFarmBoss = Tabs.Main:AddToggle("ToggleAutoFarmBoss", {Title = "Auto fram boss", Default = false })
    ...
    spawn(function()
      ...
      local ToggleTPKitsune = Tabs.Main:AddToggle("ToggleTPKitsune", {Title = "Auto đi đến đảo kisune", Default = false })
      ...
      local ToggleCollectAzure = Tabs.Main:AddToggle("ToggleCollectAzure", {Title = "Auto lụm lửa kisune", Default = false })
...
if Third_Sea then
    ...
    local ToggleSailBoat = Tabs.Main:AddToggle("ToggleSailBoat", {Title = "Auto mua thuyền", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Giết cá Crew", Default = false })
    ...
    local ToggleShip = Tabs.Main:AddToggle("ToggleShip", {Title = "Giết thuyền ", Default = false })
...
while wait() do
    ...
    local ToggleGhostShip = Tabs.Main:AddToggle("ToggleGhostShip", {Title ="Giết thuyền ma ", Default = false })
...
spawn(function()
    ...
    local ToggleElite = Tabs.Main:AddToggle("ToggleElite", {Title = "Auto cày elite hunnter", Default = false })
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Auto săn sea beast", Default = false })
...
local ToggleTweenMirageIsland = Tabs.Main:AddToggle("ToggleTweenMirageIsland", {Title = "Dịch chuyển tới đảo bí ẩn", Default = false })
...
local ToggleTweenGear = Tabs.Main:AddToggle("ToggleTweenGear", {Title = "Đi tới Gear", Default = false })
...
spawn(function()
    ...
    local Togglelockmoon = Tabs.Main:AddToggle("Togglelockmoon", {Title = "Auto khóa mặt trăng và bật tộc V3", Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto tìm đảo bí ẩn cùng nhân", Default = false })
...
if Third_Sea then
	...
	spawn(function()
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto lấy Yama", Default = false })
        ...
        local ToggleTushita = Tabs.Main:AddToggle("ToggleTushita", {Title = "Auto lấy Tushita", Default = false })
        ...
        Options.ToggleTushita:SetValue(false)
           spawn(function()
                   ...
                   local ToggleHoly = Tabs.Main:AddToggle("ToggleHoly", {Title = "Auto kiếm đuốc", Default = false })
...
if Second_Sea then
        local ToggleFactory = Tabs.Main:AddToggle("ToggleFactory", {Title = "Auto đánh nhà máy", Default = false })
        ...
        if Third_Sea then
    local ToggleCakeV2 = Tabs.Main:AddToggle("ToggleCakeV2", {Title = "Giết vua bột katakuri[nếu xuất hiện]", Default = false })
...
if Second_Sea or Third_Sea then
    local ToggleHakiColor = Tabs.Main:AddToggle("ToggleHakiColor", {Title = "Auto mua haki màu",Default = false })
...
if Second_Sea then
    local ToggleSwordLengend = Tabs.Main:AddToggle("ToggleSwordLengend", {Title = "Auto mua kiếm thần thoại",Default = false })
...
local ToggleMelee = Tabs.Setting:AddToggle("ToggleMelee", {Title = "Nâng điểm melee", Default = false })
...
local ToggleDe = Tabs.Setting:AddToggle("ToggleDe", {Title = "Nâng điểm máu", Default = false })
...
local ToggleSword = Tabs.Setting:AddToggle("ToggleSword", {Title = "Nâng điểm kiếm", Default = false })
...
local ToggleGun = Tabs.Setting:AddToggle("ToggleGun", {Title = "Nâng điểm cho súng ", Default = false })
...
local ToggleFruit = Tabs.Setting:AddToggle("ToggleFruit", {Title = "Nâng điểm trái ác quỷ", Default = false })
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Dịch chuyển đến người chơi", Default = false })
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "theo dõi người chơi", Default = false })
...
local ToggleAimBotSkill = Tabs.Player:AddToggle("ToggleAimBotSkill", {Title = "Aimbot kỹ năng", Default = false })
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Auto mua trái ác quỷ được chọn", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Auto cất trái vào balo", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Lụm trái", Default = false })
...
local ToggleBuy = Tabs.Raid:AddToggle("ToggleBuy", {Title = "mua chip raid", Default = false })
...
spawn(function()
    ...
    local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Auto bắt đầu raid", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Giết quái raid", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Auto đi tới đảo tiếp theo", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto thức tỉnh trái", Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Auto lấy trái ác quỷ ít tiền trong balo để mua chip", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Auto raid low", Default = false })
...
local ToggleAutotrial = Tabs.Race:AddToggle("ToggleAutotrial", {Title = "Auto Trial tộc v4", Default = false })
...
if Third_Sea then
local ToggleMirageIsland = Tabs.Race:AddToggle("ToggleMirageIsland", {Title = "Hop đảo bí ẩn", Default = false })
...
local ToggleRandomBone = Tabs.Shop:AddToggle("ToggleRandomBone", {Title = "Đổi xương", Default = false })
