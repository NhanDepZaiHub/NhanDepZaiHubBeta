shared.LoaderTitle = "Nhân Dz Hub V1";
...
local v15 = v14:MakeWindow({
    Title = "Nhân Dz Hub",
    SubTitle = "",
    SaveFolder = ""
})

-- Kiểm tra xem v15 có tồn tại không
if not v15 then
    warn("Lỗi: MakeWindow() không hoạt động")
    return
end

local Tabs = {
    Home = v15:AddTab({ Title = "Thông Tin" }) or warn("Lỗi tạo tab Home"),
    Main = v15:AddTab({ Title = "Cày" }) or warn("Lỗi tạo tab Main"),
    Sea = v15:AddTab({ Title = "Sự Kiện" }) or warn("Lỗi tạo tab Sea"),
    Draco = v15:AddTab({ Title = "Draco" }) or warn("Lỗi tạo tab Draco"),
    ITM = v15:AddTab({ Title = "Vật Phẩm" }) or warn("Lỗi tạo tab ITM"),
    Levi = v15:AddTab({ Title = "Cày Levi" }) or warn("Lỗi tạo tab Levi"),
    Setting = v15:AddTab({ Title = "Cài Đặt" }) or warn("Lỗi tạo tab Setting"),
    Status = v15:AddTab({ Title = "Máy Chủ" }) or warn("Lỗi tạo tab Status"),
    Stats = v15:AddTab({ Title = "Chỉ Số" }) or warn("Lỗi tạo tab Stats"),
    Player = v15:AddTab({ Title = "Người Chơi" }) or warn("Lỗi tạo tab Player"),
    Teleport = v15:AddTab({ Title = "Dịch Chuyển" }) or warn("Lỗi tạo tab Teleport"),
    Visual = v15:AddTab({ Title = "Troll" }) or warn("Lỗi tạo tab Visual"),
    Fruit = v15:AddTab({ Title = "Trái" }) or warn("Lỗi tạo tab Fruit"),
    Raid = v15:AddTab({ Title = "Tập Kích" }) or warn("Lỗi tạo tab Raid"),
    Race = v15:AddTab({ Title = "Tộc" }) or warn("Lỗi tạo tab Race"),
    Shop = v15:AddTab({ Title = "Cửa Hàng" }) or warn("Lỗi tạo tab Shop"),
    Misc = v15:AddTab({ Title = "Khác" }) or warn("Lỗi tạo tab Misc")
}

-- Kiểm tra nếu tất cả tab đều nil
local tabCount = 0
...
if tabCount == 0 then
    warn("Lỗi: Không có tab nào được tạo")
else
    print("Đã tạo " .. tabCount .. " tab thành công!")
end
...
v16.Home:AddButton({
    Title = "Discord",
    Description = "Discord Nhân Dz tại đây",
    Callback = function()
        setclipboard("https://discord.gg/dnZ7AubC");
    end
});
v16.Home:AddButton({
    Title = "Đây Là Script Nhân Dz V1",
    Description = "Sẽ sớm update V2",
    Callback = function()
    end
});
v16.Home:AddButton({
    Title = "Nếu Script lỗi nhắn discord để dc sửa",
    Description = "Tại Đây",
    Callback = function()
        setclipboard("https://discord.gg/dnZ7AubC");
    end
...
v16.Home:AddButton({
    Title = "Chúc bạn có trải nghiệm tốt",
...
local v50 = v16.Main:AddToggle("ToggleMobAura", {
    Title = "Đánh Quái Xung Quanh",
    Description = "Fram Near",
    Default = false
});
...
if Sea3 then
    ...
    local v514 = v16.Race:AddToggle("AutoFindMirage", {
        Title = "Tìm Đảo Bí Ẩn",
        Description = "",
        Default = false
    });
    ...
    local v515 = v16.Levi:AddToggle("AutoFindFrozen", {
    ...
    local v516 = v16.Levi:AddToggle("AutoComeTiki", {
...
if Sea3 then
    local v531 = v16.Race:AddSection("Đảo Bí Ẩn");
    local v532 = v16.Race:AddParagraph({
        Title = "Trạng Thái",
        Content = ""
    });
    task.spawn(function()
...
local v66 = v16.Fruit:AddToggle("ToggleTpAdvanced", {
...
local v67 = v16.Race:AddToggle("ToggleTweenGear", {
...
local v68 = v16.Race:AddToggle("Togglelockmoon", {
...
if Sea2 then
    local v540 = v16.Race:AddToggle("ToggleEvoRace", {
        Title = "Nâng Tộc V2",
        Description = "",
        Default = false
    });
...
local v135 = v16.Race:AddToggle("ToggleIslandMirageEsp", {
    Title = "Đảo Bí Ẩn",
    Description = "",
    Default = false
});
...
local v56 = v16.Levi:AddSection("Leviathan");
v16.Sea:AddButton({
...
local v155 = v16.Levi:AddToggle("ToggleTPFrozenDimension", {
...
if Sea3 then
    local v561 = v16.Levi:AddParagraph({
...
local v164 = v16.Draco:AddToggle("ToggleCollectFireFlowers", {
    Title = "Lụm Hoa Đỏ",
    Description = "",
    Default = false
});
...
local v168 = v16.Draco:AddSection("Đảo Dung Nham");
